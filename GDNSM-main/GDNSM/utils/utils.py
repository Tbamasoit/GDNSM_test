...
def get_model(model_name):
    import importlib
    module_path = f"GDNSM.models.{model_name}"
    try:
       model_module = importlib.import_module(module_path)
    except ModuleNotFoundError:
        raise ModuleNotFoundError(f"Cannot find module {module_path}, please check your folder name and PYTHONPATH.")
    model_class = getattr(model_module, model_name)
    return model_class
...
def get_trainer():
    return getattr(importlib.import_module('GDNSM.common.trainer'), 'Trainer')
